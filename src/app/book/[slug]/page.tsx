...
import { Lock, CalendarX2 } from "lucide-react"
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    title: `احجز موعدكك — ${clinic.name}`,
    description: `احجز موعدكك في ${clinic.name}`,
  }
}
...
export default async function BookClinicPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  // ═══════════════════════════════════════════════════════════════
  // ✅ FIX: فحص الـ Plan فقط (المصدر الوحيد للحقيقة)
  // ═════════════════════════════════════════════════════════════
  ...
  // ═════════════════════════════════════════════════════════════
  // ✅ حذف فحص الـ Settings تماماً - الـ Plan هو المصدر الوحيد
  // ═════════════════════════════════════════════════════════════
  // (الـ Settings يOverride الـ Plan على مستوى العيادة، لذا لا نستخدمه)
  // ═════════════════════════════════════════════════════════════
