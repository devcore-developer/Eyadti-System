// src/components/invoices/billing-overview.tsx

"use client";

import { BillingOverview as BillingOverviewType } from "@/types/subscription";
        ...
        <div className="flex items-center gap-3 p-4 bg-red-50 border border-red-200 rounded-xl">
          ...
          <div>
            ...
            <p className="text-sm text-red-600">
              Please upgrade or reactivate your plan to continue using all
              features.
            </p>
          </div>
        </div>
