...
import { Plus, FileDown, CreditCard, RotateCcw } from "lucide-react"

export function QuickInvoiceActions() {
  const [isOpen, setIsOpen] = useState(false)

  const actions = [
    { label: "New Invoice", icon: Plus, href: "/invoices/new" },
    { label: "Record Payment", icon: CreditCard, href: "/invoices/new" },
    { label: "Refund", icon: RotateCcw, href: "/invoices" },
    { label: "Export Report", icon: FileDown, href: "/invoices" },
  ]
