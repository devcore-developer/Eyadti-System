...
function FaqAccordionItem({
  ...
  return (
    <div className="overflow-hidden rounded-2xl border transition-all duration-200"
      style={{
        backgroundColor: isOpen ? "#F7FAFF" : "#FFFFFF",
    ...
    >
      ...
      >
        <span
          className="text-[15px] font-semibold pr-4 leading-[1.5]"
          style={{ color: "#0F172A" }}
        >
          {item.question}
        </span>
        <ChevronDown
          className="w-[18px] h-[18px] flex-shrink-0 transition-transform duration-200 ease-out"
          style={{
            color: "#64748B",
      ...
      >
        <div className="px-6 pb-6 pt-3">
          <p
            className="text-[15px] leading-[1.7] max-w-[760px]"
            style={{ color: "#64748B" }}
          >
            {item.answer}
          </p>
      ...
      <div className="max-w-[920px] mx-auto px-5 md:px-8">
        ...
        <div className="text-center mb-12 md:mb-14">
          ...
          <div className="flex items-center justify-center gap-2.5 mb-5">
            <div className="w-8 h-[2px] rounded-full" style={{ backgroundColor: "#3B82F6", opacity: 0.3 }} />
            <div className="w-2 h-2 rounded-full" style={{ backgroundColor: "#3B82F6", opacity: 0.5 }} />
            <div className="w-8 h-[2px] rounded-full" style={{ backgroundColor: "#3B82F6", opacity: 0.3 }} />
          </div>

          <h2
            className="text-[42px] md:text-[46px] font-extrabold leading-[1.1] mb-4"
