// components/dashboard/appointments-chart.tsx
"use client"
        ...
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
            ...
            <Area
              ...
              dot={false}
              activeDot={{ r: 6, fill: "#89D6D2", stroke: "hsl(var(--card))", strokeWidth: 3, filter: 'drop-shadow(0px 2px 4px rgba(137,214,210,0.4))' }}
            />
          </AreaChart>
        </ResponsiveContainer>
      </div>
