  ...
  return (
    <div className="prescription-page" dir={lang} style={{ direction: isArabic ? 'rtl' : 'ltr', fontFamily: isArabic ? "'Cairo', sans-serif" : "'Inter', sans-serif" }}>
      ...
      <div className="header">
        <h1>{clinic?.name || (isArabic ? "عيادة نيكسورا" : "Nexora Clinic")}</h1>
      ...
      <div className="footer-section">
        <div className="system-note">{isArabic ? "صادر من نظام نيكسورا • " : "Generated by Nexora • "}{formatDate(new Date())}</div>
